...
public:
  ...
  /// Return the number of slices for the reslice filter.
  /// 1 in most cases.
  /// \sa vtkMRMLSliceNode::SlabNumberOfSlices
  int GetSlabNumberOfSlices();
...
protected:
  ...
  void UpdateVolumeDisplayFromObservedNode(vtkMRMLVolumeDisplayNode* volumeDisplayNode,

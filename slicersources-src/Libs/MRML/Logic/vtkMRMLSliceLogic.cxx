...
{
  vtkMRMLSliceNode *sliceNode = this->GetSliceNode();
  this->GetVolumeSliceBounds(volumeNode, sliceNode, sliceBounds);
}

//----------------------------------------------------------------------------
void vtkMRMLSliceLogic::GetVolumeSliceBounds(vtkMRMLVolumeNode *volumeNode, vtkMRMLSliceNode *sliceNode, double sliceBounds[6])
{

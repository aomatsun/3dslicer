...
void qMRMLViewControllerBarPrivate::init()
{
  ...
  QObject::connect(this->PinButton, SIGNAL(clicked()),
                   this->PopupWidget, SLOT(pinPopup(true)));
  ...
  // this->PopupWidget->showPopup(true);
  // //this->PinButton->hide();
  this->PopupWidget->setAutoShow(true);
  this->PopupWidget->setAutoHide(false);
  this->PopupWidget->pinPopup(true);

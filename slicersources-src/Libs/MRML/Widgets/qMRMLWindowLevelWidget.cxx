...
//  q->setAutoWindowLevel(qMRMLWindowLevelWidget::Auto);
  ...
  QObject::connect(this->pushButton1, SIGNAL(clicked()),
                   q, SLOT(setAutoWindowLevel1()));
  q->setAutoWindowLevel(qMRMLWindowLevelWidget::Manual);     
  this->AutoManualComboBox->hide();            
}
...
void qMRMLWindowLevelWidget::setAutoWindowLevel(ControlMode autoWindowLevel)
{
  ...
  // if (button == d->pushButton)
  // {
  //   autoWindowLevel =  qMRMLWindowLevelWidget::Manual;
  // }
  // QMessageBox msgBox;
  ...
  switch (autoWindowLevel)
    ...
    case qMRMLWindowLevelWidget::Auto:
      d->WindowSpinBox->setValue(3800);
      d->LevelSpinBox->setValue(750);
      // //d->VolumeDisplayNode->setWindow
      d->WindowLevelRangeSlider->setValues(2650, -1150);
...
// // --------------------------------------------------------------------------
// void qMRMLWindowLevelWidget::setAutoWindowLevel1()
// {
//   Q_D(qMRMLWindowLevelWidget);
...
void qMRMLWindowLevelWidget::setAutoWindowLevel1()
{
  int autoWindowLevel = qMRMLWindowLevelWidget::Manual;
...
void qMRMLWindowLevelWidget::setWindowLevel(double window, double level)
{
  ...
  double oldWindow1 = window;
  double oldLevel1 = level;
  ...
  if (!qFuzzyCompare(oldWindow, d->VolumeDisplayNode->GetWindow()) ||
    ...
    emit this->windowLevelValuesChanged(oldWindow1, oldLevel1);
    }

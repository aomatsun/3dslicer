...
// --------------------------------------------------------------------------
double qMRMLSliceView::getIntersectionRASX()
{
  Q_D(const qMRMLSliceView);
...
// --------------------------------------------------------------------------
double qMRMLSliceView::getIntersectionRASY()
{
  Q_D(const qMRMLSliceView);
...
// --------------------------------------------------------------------------
double qMRMLSliceView::getIntersectionRASZ()
{
  Q_D(const qMRMLSliceView);

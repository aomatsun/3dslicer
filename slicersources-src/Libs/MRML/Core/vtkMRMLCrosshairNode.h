...
class VTK_MRML_EXPORT vtkMRMLCrosshairNode : public vtkMRMLNode
{
  ...
  /// CursorShapeXXXEvent is invoked when the mouse cursor is crossing to MPR lines
  enum
  {
    CursorPositionModifiedEvent = 22000,
    CursorShapeCenterEvent = 22001, // Invoke to crosshair cursor
    CursorShapeHorEvent = 22002, // Invoke to horizontal cursor
    CursorShapeVerEvent = 22003, // Invoke to vertical cursor
    CursorShapeSWEvent = 22004, // Invoke to BDiag cursor
    CursorShapeNWEvent = 22005, // Invoke to FDiag cursor
    CursorShapeRestoreEvent = 22010,  // Invoke to normal arrow cursor
  };

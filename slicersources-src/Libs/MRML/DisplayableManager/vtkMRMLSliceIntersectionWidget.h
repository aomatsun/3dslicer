...
public:
  ...
  vtkMRMLSliceIntersectionRepresentation2D *GetIntersectionRepresentation2D();
...
protected:
  ...
  bool IsCursorOutSlice(double *cursorRas);
  bool IsCursorOutSliceXY(int *cursorPos);
  bool GetDistanceFromAxis(double *cursorPos, double *x, double *y);
  bool GetDistanceFromAxisXY(int *cursorPos, double *x, double *y);
  bool ProcessMPR(vtkMRMLInteractionEventData *eventData);
  void UpdateCrosshair(vtkMRMLInteractionEventData *eventData);
  void UpdateCrosshairMPR(vtkMRMLInteractionEventData *eventData);
  void UpdateCrosshairOffset(double delta);

...
//---------------------------------------------------------------------------
bool vtkMRMLCrosshairDisplayableManager::GetIntersectionPoint(double ras[3])
{
  vtkMRMLSliceIntersectionWidget *widget = this->Internal->SliceIntersectionWidget;
  if (widget)
  {
    vtkMRMLSliceIntersectionRepresentation2D *rep = widget->GetIntersectionRepresentation2D();
    double *pt = rep->GetSliceIntersectionPoint();
    this->ConvertXYZToRAS(pt, ras);

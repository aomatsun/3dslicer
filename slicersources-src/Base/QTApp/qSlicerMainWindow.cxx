...
{
  // Close without confirmation if DisableExitDialog settings is true
  const bool disableExitDialog = QSettings().value("MainWindow/DisableExitDialog", false).toBool();
  if (disableExitDialog)
    {
    return true;
    }

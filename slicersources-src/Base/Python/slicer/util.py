...
def translatable(cls):
  ...
  This decorator is compatible with both Qt deriving widgets and ScriptedLoadableModuleWidget.
  The decorated class translation is equivalent to : qt.QCoreApplication.translate(<ClassName>, trString)

  Usage Example:
    @translatable
    class MyClass(ScriptedLoadableModuleWidget):
      def setup(self)
        ScriptedLoadableModuleWidget.setup(self)
        l = qt.QLabel(self.tr('Translated label'))

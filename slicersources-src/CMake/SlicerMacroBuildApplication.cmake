...
macro(slicerMacroBuildApplication)
  ...
  if(WIN32)
    if(Slicer_USE_PYTHONQT)
      ...
      if(optimized IN_LIST PYTHON_LIBRARY)
        list(GET PYTHON_LIBRARY 1 _python_library_in_release)
      else()
        set(_python_library_in_release "${PYTHON_LIBRARY}")
      endif()
      get_filename_component(_python_library_name_we "${_python_library_in_release}" NAME_WE)
      add_custom_command(

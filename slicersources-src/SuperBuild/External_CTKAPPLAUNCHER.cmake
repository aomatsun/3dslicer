...
if(Slicer_USE_CTKAPPLAUNCHER)
  ...
  if(NOT DEFINED CTKAppLauncher_DIR)
    ...
    if("${CTKAPPLAUNCHER_OS}" STREQUAL "win")
      # Download from RFCo repository on windows containing fix for japanese file path
      set(GET_COMMAND 
        GIT_REPOSITORY git@gitlab.kitware.io:rfco/ctkapplauncher.git
        GIT_TAG "c0ff426283470aeda578913b1ff1a0a4c734b2bf"
      )
    else()
      set(GET_COMMAND 

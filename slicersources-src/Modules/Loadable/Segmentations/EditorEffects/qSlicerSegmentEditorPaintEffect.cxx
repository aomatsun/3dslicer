...
void qSlicerSegmentEditorPaintEffect::setupOptionsFrame()
{
  ...
  d->EditIn3DViewsCheckbox->setToolTip(tr("Allow painting in 3D views."
    " If enabled, click-and-drag in a 3D view paints in the view instead of rotating the view."));
  ...
  d->EraseAllSegmentsCheckbox->setToolTip(tr("If not checked then highighted area is erased"

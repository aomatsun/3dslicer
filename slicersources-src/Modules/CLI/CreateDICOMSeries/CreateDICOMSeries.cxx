...
//add    
    if (!instanceCreationDate.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0008|0012", instanceCreationDate);
      }
    if (!instanceCreationTime.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0008|0013", instanceCreationTime);
      }
    if (!specificCharacterSet.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0008|0005", specificCharacterSet);
      }
    if (!institutionName.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0008|0080", institutionName);
      }
    if (!contrastBolusAgent.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|0010", contrastBolusAgent);
      }
    if (!scanOptions.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|0022", scanOptions);
      }
    if (!protocolName.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|1013", protocolName);
      }
    if (!distanceSourcetoDetector.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|1110", distanceSourcetoDetector);
      }

    if (!distanceSourcetoPatient.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|1111", distanceSourcetoPatient);
      }
    if (!rotationDirection.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|1140", rotationDirection);
      }
    if (!filterType.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|1160", filterType);
      }
    if (!convolutionKernel.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0018|1210", convolutionKernel);
      }
    ...
    if (!acquisitionNumber.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0020|0012", acquisitionNumber);
      }    
    if (!windowCenter.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0028|1050", windowCenter);
      }
    if (!windowWidth.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0028|1051", windowWidth);
      }    

    if (!transferSyntaxUID.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0002|0010", transferSyntaxUID);
      }    

    if (!implementationClassUID.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0002|0012", implementationClassUID);
      }    
    
    if (!implementationVersionName.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0002|0013", implementationVersionName);
      }    
    if (!sourceApplicationEntityTitle.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0002|0016", sourceApplicationEntityTitle);
      }    
    ...
    if (!instanceNumber.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0020|0013", instanceNumber);
      } 
    if (!rows.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0028|0010", rows);
      } 
    if (!columns.empty())
      {
      itk::EncapsulateMetaData<std::string>(dictionary, "0028|0011", columns);
      } 

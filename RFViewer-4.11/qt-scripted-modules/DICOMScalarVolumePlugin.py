  ...
  def export(self,exportables):
    for exportable in exportables:
      ...
      if y > 0 and m > 0 and d > 0:
        tags['Patient Birth Date'] = qt.QDate(y , m , d).toString("yyyy.MM.dd")
      else:
      ...
      if y1 > 0 and m1 > 0 and d1 > 0:
        tags['Study Date'] = qt.QDate(y1 , m1 , d1).toString("yyyy.MM.dd")
      else:
